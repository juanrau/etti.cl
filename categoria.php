              ...
              <div class="card-body table-responsive p-0">
                ...
                try {
                  ...
                  foreach ($conn->query($sql) as $row) {
                      echo "<tr><td>".$row[0] . "</td><td>" . $row[1] . "</td><td> <div> <a class='btn bg-gradient-success btn-xs' href='acategoria.php'> Agregar </a> <a  class='btn bg-gradient-warning btn-xs' href='#'> Editar </a> <a  class='btn bg-gradient-danger btn-xs' href='#'> Eliminar </a> </div></td></tr>";
                  }
                  $conn = null;
