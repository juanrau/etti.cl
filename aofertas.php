      ...
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-lg-12">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="/covid/php/agroferta.php" method="post" enctype="multipart/form-data">
                <div class="card-body">
                ...
                <div class="card-footer separador bg-gradient-success1">
                 <button type="submit" class="btn btn-primary"  > Agregar </button>    <a class="btn btn-primary" href="lofertas.php"  > Volver </a>  
                </div>
              </form>
